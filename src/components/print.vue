    ...
    <div id="box">
        ...
        <div>
          <div>备注：</div>
              ...
              <el-button type="primary" @click="Print">打印</el-button><br/>
              <el-button type="primary" @click="borardPrint">补打板贴</el-button>
              <el-button type="primary" @click="boxPrint">补打箱贴</el-button>
    </div>
